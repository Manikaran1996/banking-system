...
# from sbs.models.tables import Base
...
def init():
    ...
    emp_privilege_level = 10
    emp_name = 'M.K.K'
    branch_name = 'New India Branch'
    branch_code = 'NIB0001'
    branch_address = 'Plot number 20, Block-16, Delhi'
    emp_obj = Employee(emp_id=emp_id, emp_name=emp_name, designation=emp_designation)
    online_user = OnlineUser(user_name=admin_user, employee_id=emp_id, password=admin_password, privilege_level=emp_privilege_level)
